...
print("########## NOTE ########")
print("For Active\Inactive classes images in train set:")
print(r"Use active, active_156 for generating images for the folders: Feature_data\Image_type1\train\active and Feature_data\Image_type1\test\active")
print(r"Use inactive, inactive_156 for generating images for the folder Feature_data\Image_type1\train\inactive and Feature_data\Image_type1\test\inactive")
print("############ ###########\n")

print(r"Feature_data\Image_type1\train\active.csv")
print(r"Feature_data\Image_type1\train\active_156.csv")
print(r"Feature_data\Image_type1\train\inactive.csv")
print(r"Feature_data\Image_type1\train\inactive_156.csv")

print("\n")
print(r"Feature_data\Image_type1\test\active.csv")
print(r"Feature_data\Image_type1\test\active_156.csv")
print(r"Feature_data\Image_type1\test\inactive.csv")
print(r"Feature_data\Image_type1\test\inactive_156.csv")

print("\n")
print ("Use -o as:")

#print("Output to train folder") 
print(r"Image_data\Image_type1\train\active")
print(r"Image_data\Image_type1\train\inactive")

#print("Output to test folder") 
print(r"Image_data\Image_type1\test\active")
print(r"Image_data\Image_type1\test\inactive")
